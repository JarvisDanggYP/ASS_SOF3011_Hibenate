...
<nav class="navbar navbar-light navbar-expand-md sticky-top navbar-shrink py-3" id="mainNav">
    ...
    <%--                    </svg></span><span>OnlyTrung</span></a>--%>
    ...
    <ul class="navbar-nav mx-auto">
        ...
        <li class="nav-item"><a class="nav-link active" href="/khach-hang/index">Khách Hàng</a></li>
        <li class="nav-item"><a class="nav-link active" href="/mau-sac/index">Màu Sắc</a></li>
        ...
        <div class="row pt-5">
            <div class="col-md-8 col-xl-6 text-center text-md-start mx-auto">
                <div class="text-center">
                    ...
                    <h1 class="fw-bold">Hệ Thống Quản Lý Thông Minh</h1>
                </div>
            </div>
...
<footer class="bg-primary-gradient">
    <div class="container py-4 py-lg-5">
        ...
        <div class="text-muted d-flex justify-content-between align-items-center pt-3">
            <p class="mb-0">Copyright © 2023 From Đặng Trung With Love</p>
